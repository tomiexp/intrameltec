...
export const PermissionForm = () => {
  const { data, setData, post, processing, errors, reset } = useForm({ permission: '' })
  ...
  return (
    <form onSubmit={save}>
      <div className='my-6'>
        <Input type='text' onChange={handleNewPermission} label='Nuevo Permiso' isRequired radius='sm' />
      </div>
